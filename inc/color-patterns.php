 ...
 */
function wordjax_custom_colors_css() {
	...
	/**
	 * Filter WordJax default saturation level.
	 *
	 * @since WordJax 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = apply_filters( 'wordjax_custom_colors_saturation', 100 );
	$saturation = absint( $saturation ) . '%';

	/**
	 * Filter WordJax default selection saturation level.
	 *
	 * @since WordJax 1.0
	 *
	 * @param int $saturation_selection Selection color saturation level.
	 */
	$saturation_selection = absint( apply_filters( 'wordjax_custom_colors_saturation_selection', 50 ) );
	$saturation_selection = $saturation_selection . '%';

	/**
	 * Filter WordJax default lightness level.
	 *
	 * @since WordJax 1.0
	 *
	 * @param int $lightness Color lightness level.
	 */
	$lightness = apply_filters( 'wordjax_custom_colors_lightness', 33 );
	$lightness = absint( $lightness ) . '%';

	/**
	 * Filter WordJax default hover lightness level.
	 *
	 * @since WordJax 1.0
	 *
	 * @param int $lightness_hover Hover color lightness level.
	 */
	$lightness_hover = apply_filters( 'wordjax_custom_colors_lightness_hover', 23 );
	$lightness_hover = absint( $lightness_hover ) . '%';

	/**
	 * Filter WordJax default selection lightness level.
	 *
	 * @since WordJax 1.0
	 *
	 * @param int $lightness_selection Selection color lightness level.
	 */
	$lightness_selection = apply_filters( 'wordjax_custom_colors_lightness_selection', 90 );
	 ...
	 */
	return apply_filters( 'wordjax_custom_colors_css', $theme_css, $primary_color, $saturation );
}
